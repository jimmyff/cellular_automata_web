...
_.b=b
_.c=c
_.$ti=d},c5:function c5(){},c6:function c6(){},c7:function c7(){},c8:function c8(){},c9:function c9(){},ca:function ca(){},cb:function cb(){},cc:function cc(){},cd:function cd(){},ce:function ce(){},cf:function cf(){},
...
$.f9=C.t}t.aL().a_(new K.dK())
t=P.n
s=P.fR(P.fS([C.j,"#000",C.l,"#483D8B",C.m,"#00008B",C.f,"#FF69B4",C.i,"#FFC0CB"]),X.q,t)
r=[A.O,t]
...
n=P.fJ(0,0,0,67,0,0)
m=new T.cr(P.eG(t,[R.I,,,]),n,0,64,64,0,null,q,r,p,0,o,[t])
$.$get$bg().B(C.o,"Max Age: null",null,null)
l=new S.aC(64,64)
t=document
r=t.querySelector("#canvas")
$.$get$f6().B(C.o,"Canvas: 64x64 (512x512px)",null,null)
r.width=512
r.height=512
l.e=r
l.c=8
...
r.right="0px"
r.bottom="0px"
break}new P.M(o,[H.k(o,0)]).a_(new K.dL(m,64,64,s))
new P.M(q,[H.k(q,0)]).a_(H.hz(l.gcn(),null))
new P.M(p,[H.k(p,0)]).a_(new K.dM(m))
...
j.toString
W.d_(j,"click",new K.dN(m),!1)
i.toString
W.d_(i,"click",new K.dO(m),!1)
k.toString
W.d_(k,"click",new K.dP(m),!1)
h.toString
W.d_(h,"click",new K.dQ(m),!1)
m.aA(0)},
dK:function dK(){},
...
dP:function dP(a){this.a=a},
dQ:function dQ(a){this.a=a}},E={aW:function aW(a,b){this.a=a
...
if(t==null)t=0
s=this.a
s.push(Y.fM(t+1,this.c,this.d,a,a.bS(H.w([C.i,C.f],[X.q]),this.e.a)))
t=s.length
...
switch(t){case C.f:case C.i:s=J.fk(m)
if(s.K(m,2))return C.l
if(C.c.b3(H.w([2,3],[P.l]),m))return C.f
if(s.V(m,3))return C.m
break
case C.j:case C.l:case C.m:if(J.bn(m,3))return C.i
break}return t}}
X.bJ.prototype={
...
r=this.c
q=X.q
p=new X.bI(P.eH([C.f,1,C.i,1,C.j,0,C.l,0,C.m,0],q,P.l))
...
C.z=new P.D(1e4)
C.A=new P.D(1e6)
C.f=new X.q(0,"GameOfLifeStates.alive")
C.i=new X.q(1,"GameOfLifeStates.aliveBorn")
...
if(typeof dartMainRunner==="function")dartMainRunner(K.fs,[])
else K.fs([])})})()
